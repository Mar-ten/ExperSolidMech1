...
\begin{figure}[H]
\centering
\include{graphics}[plot1.png]
\caption{}
\end{figure}

\section{Results} %No new info, report observations (John)

\section{Discussion} %John
...
\section{Tables}
% Collected Data (force voltage strain)
% All layups
% Layups strain LPT
\section{Appendix}
% LPT code
